...
ALTER ROLE postgres WITH SUPERUSER INHERIT CREATEROLE CREATEDB LOGIN REPLICATION BYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:TLRSwr/Kgpe/d2kRipgbZg==$RnckQ7SC8JdrcTXKEnJJiia2FRc9LKrim9CgWVlzYU0=:rhPMk+9DxPrxhyIhK4jtnBBWuqom4mBrH4PrlEHnhPc=';
...
CREATE DATABASE ecommerce_db WITH TEMPLATE = template0 ENCODING = 'UTF8' LOCALE_PROVIDER = libc LOCALE = 'English_Indonesia.1252';
...
COPY public.users (id, email, password, is_admin, created_at) FROM stdin;
1	admin@example.com	$2b$10$PuV5LqBLlOhDQZjsaUQNmOS6EMvQkk74xnCSbIjWor7H26um06KUi	t	2024-12-05 01:41:20.3997+07
2	test@example.com	$2b$10$0eU4DgFAPbVxIWjzKRtaNuh5QwMCP0DkWSzvcHQpw9M/867.19CqC	f	2024-12-05 01:42:51.925692+07
\.
...
COPY public.addresses (address_id, user_id, address_type, street_address, city, state, postal_code, country, is_default) FROM stdin;
\.
...
COPY public.cart (cart_id, user_id, product_id, quantity, created_at, updated_at) FROM stdin;
\.
...
1	Clothing	All types of apparel	2024-12-05 01:10:45.705285
2	Electronics	Electronic devices and accessories	2024-12-05 01:10:45.705285
3	Accessories	Fashion accessories	2024-12-05 01:10:45.705285
\.
...
COPY public.order_items (order_item_id, order_id, product_id, quantity, price_at_time, created_at) FROM stdin;
\.
...
COPY public.orders (order_id, user_id, shipping_address_id, billing_address_id, total_amount, status, created_at, updated_at) FROM stdin;
\.
...
COPY public.products (product_id, category_id, name, description, price, stock_quantity, image_url, created_at, updated_at) FROM stdin;
\.
...
COPY public.reviews (review_id, product_id, user_id, rating, comment, created_at, updated_at) FROM stdin;
\.
...
COPY public.users (user_id, username, email, password_hash, first_name, last_name, is_admin, created_at, updated_at) FROM stdin;
\.
